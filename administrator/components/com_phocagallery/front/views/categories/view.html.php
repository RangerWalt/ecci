...
class PhocaGalleryViewCategories extends JView
{
	function display($tpl = null) {		
		...
		switch ($image_categories_size) {	
			case 4:
			case 6:			
				$tmpl['imagebg'] = 'background: url(\''
					.JURI::base(true)
					.'/components/com_phocagallery/assets/images/shadow3.'
					.PhocaGalleryHelperFront::getFormatIcon()
					.'\') 50% 50% no-repeat;height:'
					.$small_image_height.'px;width:'
					.$small_image_width.'px;';
				$tmpl['imagewidth'] = $small_image_width + 20;//Categories Detailed View
			break;
			...
			case 7:
				$tmpl['imagebg'] = 'background: url(\''
					...
					.$medium_image_height.'px;width:'
					.$medium_image_width.'px;';
					$tmpl['imagewidth'] = $medium_image_width + 20;//Categories Detailed View
			break;
