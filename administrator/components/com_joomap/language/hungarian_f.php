...
if( !defined( 'JOOMAP_LANG' )) {
    ...
    // -- Tips ---------------------------------------------------------------------
    define('_JOOMAP_EXCLUDE_MENU_TIP',		'Adja meg a helyt�rk�pb�l kihagyand� men�azonos�t�kat.<br /><strong>MEGJEGYZ�S</strong><br />V�lassza el vessz�vel az azoos�t�kat!');
    define('_JOOMAP_CFG_GOOGLE_MAP_TIP',	'A GoogleSiteMap sz�m�ra gener�lt XML f�jl');
    define('_JOOMAP_GOOGLE_LINK_TIP',		'M�solja ki a hivatkoz�st �s k�ldje be a GoogleSiteMap-nek');

    // -- Menus --------------------------------------------------------------------
    define("_JOOMAP_CFG_SET_ORDER", "Hat�rozza meg a men�k megjelen�t�s�nek sorrendj�t");
    ...
    define("_JOOMAP_CFG_DISABLE", "Kattintson r� a letilt�shoz");
    define("_JOOMAP_CFG_ENABLE", "Kattintson r� az enged�lyez�shez");
