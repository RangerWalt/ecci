...
<div id="top-wrapper">
<div id="header-flag"><jdoc:include type="modules" name="userflag" style="none" /></div>
...
<?  //banner
	...
	else if($secid==64 || $secid==65 || $secid==95) $banner = "teasercompany";
	else if($secid==66 || $secid==96) $banner = "teaserpeople";
	else if($secid==67 || $secid==97) $banner = "teaservalues";
	else if($secid==66 || $secid==67 || $secid==68  )$banner = "teaseraboutus";
	else if($secid==95 || $secid==97 || $secid==98  )$banner = "teaseraboutus";
	...
	else if($secid==79 || $secid==81 || $secid==82 || $secid==83 || $secid==92 || $secid==93 || $secid==94 ||  $secid==83) $banner ="teaserpartners";
	...
	else if($secid==371 )$banner = "teaserservicemanaged";
	else if($secid==112 || $secid==269 || $secid==697)$banner = "teasercustomtraining";
	
	else if($secid==100 || $secid==224 || $secid==291 || $secid==377 || $secid==353 )$banner = "teaserstandards";
	else if($secid==117 || $secid==684 )$banner = "teaserexperience";
	else if($secid==355 || $secid==141 || $secid==290 || $secid==300 || $secid==379 || $secid==360 )$banner = "teaserapproach";
	...
	//main menu training
	else if($secid==71 || $secid==853 || $secid==850 || $secid==857 || $secid==858 || $secid==859 || $secid==860  || $secid==861 || $secid==862  ) $banner = "teaserservicetraining";
	...
	//main menu
	else if($secid==73)$banner = "teaserserviceassessment";
	
	else if($secid==403 || $secid==376 || $secid==245 || $secid==444 || $secid==453 || $secid==462  || $secid==471)$banner = "teaserserviceassessment";
	else if($secid==368 || $secid==364 || $secid==372 || $secid==399 || $secid==435) $banner = "teaserserviceassessment";
...
<?php //if ($this->countModules('icon')) : ?>
	<div id="teaser-wrapper" style="z-index:-100;">
		...
		<table width="600px" border="0" height="100%" cellspacing="0" cellpadding="0">
		  ...
		  <tr><td colspan="3"><br />
				...
				<?php if ($this->countModules('banner2')) : ?>
						<div id="banner2"><jdoc:include type="modules" name="banner2" style="none" /></div>
					<?php endif; ?></td></tr>
				</table>
			</td>
		</tr>
