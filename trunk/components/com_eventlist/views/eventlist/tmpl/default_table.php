...
<script type="text/javascript">
	...
	function moFilter(mo)
	{
		var form = document.getElementById("adminForm");
		//var hidden_field = document.getElementById('my_hidden_field');
...
<div id="el_filter" class="floattext">
		...
		<div class="el_fleft">
			...
			?>
				...
				<? echo '<label for="filter_type">'.JText::_('Country').'</label>&nbsp;';	?>
		...
		<br /><br />
		 <div align="center">
			<input type="hidden" name="mnt" id="mnt"  />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Jan" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Feb" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Mar" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Apr" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="May" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Jun" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Jul" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Aug" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Sep" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Oct" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Nov" />
			<input type="button" class="mobutton" onclick="moFilter(this.value);" name="mon" value="Dec" />	
		 </div>
		<?php endif; ?>
</div>
<?php endif; ?>
