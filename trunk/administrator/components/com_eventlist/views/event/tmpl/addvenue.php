<?php
/**
 * @version 1.0 $Id: addvenue.php 662 2008-05-09 22:28:53Z schlu $
 * @package Joomla
...
<fieldset>
	...
	<table class="adminform" width="100%">
		...
		<? //Removed to hide country and  use state field instead ?>
  	<!--	<tr>
  		  	<td><?php echo JText::_( 'COUNTRY' ).':'; ?></td> 
  		  	<td> -->
				<input name="country" value="" size="4" maxlength="3" style="display:none"/>&nbsp;
