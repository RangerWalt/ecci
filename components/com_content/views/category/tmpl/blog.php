...
<tr>
	<td valign="top">
		...
		<?php
			...
			<?	if ( $z&1 ) $padding="padding-left: 7px;"; 
			    if ( !$z&1 ) $padding.="padding-right: 7px;";  ?>
				<td  style=" <?=$padding?> "  valign="top" width="<?php echo intval(100 / $this->params->get('num_columns')) ?>%" class="article_column<?php echo $divider ?>">
